		...
		<div className="h-full bg-black text-white overflow-hidden">
			...
			<div className="container px-4 lg:pl-40 mx-auto py-20 lg:py-[60px] relative">
				<h1 data-aos="fade-right" className="relative w-1/2 md:w-1/3">
					{" "}
					<span className="text-6xl text-bold before:text-accent before:[''] before:absolute before:border-b-4 before:border-accent before:top-2 before:left-0 before:w-0 before:h-[100%] before:overflow-hidden before:text-7xl before:animate-animate">
						<span className="text-[#70C878]">A</span>bout Me
					</span>
				</h1>
				<Link to="/contact" className="flex justify-end items-start">
					<button className="border-2 border-primary text-primary min-w-[160px]  min-h-[48px] rounded-md hover:text-lg transition-all duration-150">
						Contact
					</button>
				</Link>
