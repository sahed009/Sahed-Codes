...
const ContactFormCard = () => (
  <div
    data-aos="fade-right"
    className="bg-[#191716] shadow-xl rounded-2xl p-6 md:p-12 border border-[#70C878]"
  >
        ...
        <div className="grid grid-cols-12 py-6 lg:gap-8">
          <div className="col-span-12 lg:col-span-7 p-16 mb-4 lg:mb-0 ">
            ...
            <img
              ...
              srcSet={`${profileImg}?w=320 320w,
                 ${profileImg}?w=640 640w,
                 ${profileImg}?w=768 768w,
                 ${profileImg}?w=1024 1024w,
                 ${profileImg}?w=1200 1200w,
                 ${profileImg}?w=1600 1600w,
                 ${profileImg}?w=1920 1920w`}
            />
          </div>
