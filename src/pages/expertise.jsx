        ...
        >
          <div className="h-16 w-16 rounded-xl text-[32px] inline-flex items-center justify-center mb-6">
            <img
              ...
              srcSet={`${feature.img}?w=320 320w,
								 ${feature.img}?w=640 640w,
								 ${feature.img}?w=768 768w,
								 ${feature.img}?w=1024 1024w,
								 ${feature.img}?w=1200 1200w,
								 ${feature.img}?w=1600 1600w,
								 ${feature.img}?w=1920 1920w`}
            />
          </div>
      ...
      <div className="container px-4 lg:pl-40 mx-auto py-20 lg:py-10 relative">
        <div data-aos="fade-right">
          ...
          <p className="text-lg leading-6 my-6">
            I specialize in React.js for dynamic interfaces and Tailwind CSS for
            sleek, responsive designs. Let's create an exceptional online
            presence together!
          </p>
        </div>

        {features.map((feature, i) => (
          <FeatureItem align={i % 2 ? false : true} feature={feature} key={i} />
        ))}
      </div>
      <Footer />
    </section>
